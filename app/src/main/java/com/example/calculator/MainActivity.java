...
public class MainActivity extends AppCompatActivity {
    ...
    //variables to hold operand and tupe of calculation
        ...
        clear.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(value.length()>0){
                    ...
                    String s1=displayOperation.getText().toString();
                    if(s1!="="){
                        displayOperation.setText("=");
                    }
                    else{
                        String s2=result.getText().toString();
                        if(s2.length()>0) {
                            Double doubleValue =Double.valueOf(s2);
                            doubleValue*= 0;
                            result.setText("");
                            operand1*=0;
                        }
